                ...
                <div className="container my-p py-5">
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <h1 className="display-6"><b>Who </b><b>We </b><b>Are</b></h1>
                            <hr />
                    ...
                    <div className="row">   
                            ...
                            className="rounded mx-auto d-block w-25  mt-2"/>  
                    </div>
                    <div className="row">   
                            <p className="lead mx-auto mt-5" >
                    ...
                    <div className="row">     
                        <p className="lead text-center mx-auto mt-5" >
                            ***
                        </p>
                    </div>
                    <div className="row">     
                    ...
                    <div className="row">     
                        <h3 className="text-center fs-7 mx-auto mt-5" >
                            Together they live rock as its best
                        </h3>
                    </div> 
                </div>
            </section>
